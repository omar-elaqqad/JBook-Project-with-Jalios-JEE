...
<% 
  Publication pub = (Publication)request.getAttribute("faq-entry");
  ...
  String modalUrl = "types/FaqEntry/editFaqEntryModal.jsp?id=" + pub.getId();
%>
...
<div class="dropdown-container">
  <div class="dropdown">
    ...
    <!-- Dropdown menu links -->
      ...
      <% if (canRecommend) { %>
        <jalios:recommendation data="<%= pub %>">
          <jalios:icon src="recommendation" alt='<%= glp("ui.recommendation") %>'  /> 
