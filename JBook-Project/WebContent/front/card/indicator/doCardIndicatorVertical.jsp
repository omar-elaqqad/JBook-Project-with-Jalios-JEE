...
<% } %>
 <div <%= htmlAttributes %> class="<%= css %> card-indicator card-indicator-vertical"<%= dataAttribute != null ? " " + dataAttribute.toString() : "" %>
   ...
   <jalios:cardBlock>
     <div class="indicator-content">
       ...
       <% } else { %> 
       <span class="indicator-number <%= numberCss %>">
         <jalios:icon css="<%= jaliosIconCss %>" src="<%= icon  %>" />
         <%= roundedNumber %><span class="indicator-unit"><%= unit %></span>
       </span>
       <% } %>
