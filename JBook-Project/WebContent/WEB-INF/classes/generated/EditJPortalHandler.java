...
public boolean validateBeforeOp() {
...

    {
      ...
      this.portlets = list.toArray(new com.jalios.jcms.portlet.Portlet[0]);
    }
...
public boolean validateCreate() throws java.io.IOException {
    if (!super.validateCreate() || !validateCommonCreateUpdateJPortal()) {
      return false;
    }
    return true;
  }
...
public boolean validateUpdate() throws java.io.IOException {
    if (!super.validateUpdate() || !validateCommonCreateUpdateJPortal()) {
      return false;
    }
