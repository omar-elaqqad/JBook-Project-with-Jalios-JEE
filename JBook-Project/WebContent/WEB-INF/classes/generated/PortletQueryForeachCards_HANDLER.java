...
public class PortletQueryForeachCards_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletQueryForeachCards handler = (generated.PortletQueryForeachCards)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("cardsPerLine");
    if (value != null) {
      handler.setCardsPerLine((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cardsPerLine")));
    }

    value = attributes.get("cardCssClass");
    if (value != null) {
      handler.setCardCssClass((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cardCssClass")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletQueryForeachCards handler = (generated.PortletQueryForeachCards)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("cardsPerLine", StoreUtil.encodeObject(handler.getCardsPerLine(), store));
    attributes.put("cardCssClass", StoreUtil.encodeObject(handler.getCardCssClass(), store));
