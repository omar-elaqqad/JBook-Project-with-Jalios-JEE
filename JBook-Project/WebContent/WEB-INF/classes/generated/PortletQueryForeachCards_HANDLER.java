...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setCardsPerLine(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cardsPerLine")));
    }

    value = attributes.get("cardCssClass");
    if (value != null) {
      handler.setCardCssClass(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cardCssClass")));
    }
