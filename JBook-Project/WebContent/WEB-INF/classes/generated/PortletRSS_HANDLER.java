...
// Generation date: Thu Apr 04 15:21:47 WET 2024
...
public class PortletRSS_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletRSS handler = (generated.PortletRSS)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("source");
    if (value != null) {
      handler.setSource((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "source")));
    }
    ...
    value = attributes.get("showDescription");
    if (value != null) {
        handler.setShowDescription(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showImage");
    if (value != null) {
        handler.setShowImage(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showWebMastersEmail");
    if (value != null) {
        handler.setShowWebMastersEmail(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showItemsDescription");
    if (value != null) {
        handler.setShowItemsDescription(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("openLinksInNewWindow");
    if (value != null) {
        handler.setOpenLinksInNewWindow(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("trackingEnabled");
    if (value != null) {
        handler.setTrackingEnabled(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("refresh");
    if (value != null) {
        try {handler.setRefresh((Long.valueOf(value)).longValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("maxItems");
    if (value != null) {
        try {handler.setMaxItems((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("skipFirstItems");
    if (value != null) {
        try {handler.setSkipFirstItems((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("sortAttribute");
    if (value != null) {
      handler.setSortAttribute((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "sortAttribute")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletRSS handler = (generated.PortletRSS)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("source", StoreUtil.encodeObject(handler.getSource(), store));
    attributes.put("showTitle", String.valueOf(handler.getShowTitle()));
    attributes.put("showDescription", String.valueOf(handler.getShowDescription()));
    attributes.put("showImage", String.valueOf(handler.getShowImage()));
    attributes.put("showWebMastersEmail", String.valueOf(handler.getShowWebMastersEmail()));
    attributes.put("showItemsDescription", String.valueOf(handler.getShowItemsDescription()));
    attributes.put("openLinksInNewWindow", String.valueOf(handler.getOpenLinksInNewWindow()));
    attributes.put("trackingEnabled", String.valueOf(handler.getTrackingEnabled()));
    attributes.put("refresh", String.valueOf(handler.getRefresh()));
    attributes.put("maxItems", String.valueOf(handler.getMaxItems()));
    attributes.put("skipFirstItems", String.valueOf(handler.getSkipFirstItems()));
    attributes.put("sortAttribute", StoreUtil.encodeObject(handler.getSortAttribute(), store));
