...
public class PortletIndicator_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletIndicator handler = (generated.PortletIndicator)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("indicatorType");
    if (value != null) {
      handler.setIndicatorType((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "indicatorType")));
    }

    value = attributes.get("value");
    if (value != null) {
        try {handler.setValue((Double.valueOf(value)).doubleValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("targetValue");
    if (value != null) {
        try {handler.setTargetValue((Double.valueOf(value)).doubleValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("percentage");
    if (value != null) {
        handler.setPercentage(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("label");
    if (value != null) {
      handler.setLabel((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "label")));
    }

    value = attributes.get("labelML");
    if (value != null) {
      handler.setLabelML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "labelML")));
    }

    value = attributes.get("unit");
    if (value != null) {
      handler.setUnit((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "unit")));
    }

    value = attributes.get("primaryColor");
    if (value != null) {
      handler.setPrimaryColor((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "primaryColor")));
    }

    value = attributes.get("secondaryColor");
    if (value != null) {
      handler.setSecondaryColor((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "secondaryColor")));
    }

    value = attributes.get("animation");
    if (value != null) {
        handler.setAnimation(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("briefText");
    if (value != null) {
      handler.setBriefText((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "briefText")));
    }

    value = attributes.get("briefTextML");
    if (value != null) {
      handler.setBriefTextML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "briefTextML")));
    }

    value = attributes.get("metric");
    if (value != null) {
      handler.setMetric((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "metric")));
    }

    value = attributes.get("metricParameters");
    if (value != null) {
      handler.setMetricParameters((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "metricParameters")));
    }

    value = attributes.get("linkType");
    if (value != null) {
      handler.setLinkType((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "linkType")));
    }

    value = attributes.get("publicationLink");
    if (value != null) {
      handler.setPublicationLink((com.jalios.jcms.Content)StoreUtil.decodeObject(com.jalios.jcms.Content.class, value, store, new DecodeContext(sle, "publicationLink")));
    }

    value = attributes.get("publicationLinkDBID");
    if (value != null) {
      handler.setPublicationLinkDBID((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "publicationLinkDBID")));
    }

    value = attributes.get("linkLabel");
    if (value != null) {
      handler.setLinkLabel((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "linkLabel")));
    }

    value = attributes.get("linkLabelML");
    if (value != null) {
      handler.setLinkLabelML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "linkLabelML")));
    }

    value = attributes.get("picture");
    if (value != null) {
      handler.setPicture((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "picture")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletIndicator handler = (generated.PortletIndicator)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("indicatorType", StoreUtil.encodeObject(handler.getIndicatorType(), store));
    attributes.put("value", String.valueOf(handler.getValue()));
    attributes.put("targetValue", String.valueOf(handler.getTargetValue()));
    attributes.put("percentage", String.valueOf(handler.getPercentage()));
    ...
    attributes.put("unit", StoreUtil.encodeObject(handler.getUnit(), store));
    attributes.put("primaryColor", StoreUtil.encodeObject(handler.getPrimaryColor(), store));
    attributes.put("secondaryColor", StoreUtil.encodeObject(handler.getSecondaryColor(), store));
    attributes.put("animation", String.valueOf(handler.getAnimation()));
    attributes.put("briefText", StoreUtil.encodeObject(handler.getBriefText(), store));
    attributes.put("briefTextML", StoreUtil.encodeObject(handler.getBriefTextML(), store));
    attributes.put("metric", StoreUtil.encodeObject(handler.getMetric(), store));
    attributes.put("metricParameters", StoreUtil.encodeObject(handler.getMetricParameters(), store));
    attributes.put("linkType", StoreUtil.encodeObject(handler.getLinkType(), store));
    attributes.put("publicationLink", StoreUtil.encodeObject(handler.getPublicationLink(), store));
    attributes.put("publicationLinkDBID", StoreUtil.encodeObject(handler.getPublicationLinkDBID(), store));
    attributes.put("linkLabel", StoreUtil.encodeObject(handler.getLinkLabel(), store));
    attributes.put("linkLabelML", StoreUtil.encodeObject(handler.getLinkLabelML(), store));
