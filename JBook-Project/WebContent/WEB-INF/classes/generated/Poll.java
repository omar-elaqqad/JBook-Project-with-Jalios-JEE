...
public void setOptions(String[] v) { options = v; }
  ...
  @Override
public String[] getOptions(String lang) { return channel.getLangValue(lang, true, options, optionsML, getMainLanguage()); }
  @Override
public String[] getOptions(String lang, boolean useDefault) { return channel.getLangValue(lang, useDefault, options, optionsML, getMainLanguage()); }
  @Override
...
public ControllerStatus checkIntegrity() {
    ...
    if (Util.isEmpty(getFieldInMainLanguage(options, optionsML), true)) {
