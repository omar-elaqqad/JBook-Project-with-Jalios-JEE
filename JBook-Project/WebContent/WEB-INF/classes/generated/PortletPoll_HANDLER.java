...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setPoll(StoreUtil.decodeObject(generated.Poll.class, value, store, new DecodeContext(sle, "poll")));
    }

    value = attributes.get("refineWorkspace");
    if (value != null) {
      handler.setRefineWorkspace(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "refineWorkspace")));
    }
