...
// Generation date: Fri Apr 05 09:11:53 WET 2024
...
public class PortletPoll_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletPoll handler = (generated.PortletPoll)storable;
    String value;
    ...
    value = attributes.get("poll");
    if (value != null) {
      handler.setPoll((generated.Poll)StoreUtil.decodeObject(generated.Poll.class, value, store, new DecodeContext(sle, "poll")));
    }

    value = attributes.get("refineWorkspace");
    if (value != null) {
      handler.setRefineWorkspace((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "refineWorkspace")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletPoll handler = (generated.PortletPoll)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("hideWhenNoResults", String.valueOf(handler.getHideWhenNoResults()));
    attributes.put("poll", StoreUtil.encodeObject(handler.getPoll(), store));
    attributes.put("refineWorkspace", StoreUtil.encodeObject(handler.getRefineWorkspace(), store));
