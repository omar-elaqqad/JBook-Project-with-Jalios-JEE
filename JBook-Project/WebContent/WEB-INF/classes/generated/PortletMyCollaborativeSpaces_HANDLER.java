...
// Generation date: Fri Apr 05 09:13:16 WET 2024
...
public class PortletMyCollaborativeSpaces_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletMyCollaborativeSpaces handler = (generated.PortletMyCollaborativeSpaces)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("depth");
    if (value != null) {
        try {handler.setDepth((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("typologyFilter");
    if (value != null) {
        handler.setTypologyFilter(Boolean.valueOf(value).booleanValue());
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletMyCollaborativeSpaces handler = (generated.PortletMyCollaborativeSpaces)storable;
    Map<String,String> attributes = new HashMap<>();
    attributes.put("depth", String.valueOf(handler.getDepth()));
    attributes.put("typologyFilter", String.valueOf(handler.getTypologyFilter()));
