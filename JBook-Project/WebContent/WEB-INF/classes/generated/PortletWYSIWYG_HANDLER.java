...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setWysiwyg(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "wysiwyg")));
    }

    value = attributes.get("wysiwygML");
    if (value != null) {
      handler.setWysiwygML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "wysiwygML")));
    }
