...
public class PortletWYSIWYG_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletWYSIWYG handler = (generated.PortletWYSIWYG)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("wysiwyg");
    if (value != null) {
      handler.setWysiwyg((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "wysiwyg")));
    }

    value = attributes.get("wysiwygML");
    if (value != null) {
      handler.setWysiwygML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "wysiwygML")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletWYSIWYG handler = (generated.PortletWYSIWYG)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("wysiwyg", StoreUtil.encodeObject(handler.getWysiwyg(), store));
    attributes.put("wysiwygML", StoreUtil.encodeObject(handler.getWysiwygML(), store));
