...
// Generation date: Fri Apr 05 09:11:52 WET 2024
...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setOptions(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "options")));
    }

    value = attributes.get("optionsML");
    if (value != null) {
      handler.setOptionsML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "optionsML")));
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.Poll handler = (generated.Poll)storable;
    ...
    attributes.put("options", StoreUtil.encodeObject(handler.getOptions(), store));
    attributes.put("optionsML", StoreUtil.encodeObject(handler.getOptionsML(), store));
