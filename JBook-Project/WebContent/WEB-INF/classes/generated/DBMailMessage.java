...
import com.jalios.jcms.db.DataSetHelper;
...
protected void importXmlFieldsWithReferences(org.jdom.Element elt, ImportOptions options) {
    ...
    setAttachements(ImportUtil.parseFieldDataSet(elt, "attachements", com.jalios.jcms.FileDocument.class));
    }
  }
...
public void setFrom(String v) { from = v; }
  ...
  protected  Set<String> to = new HashSet<>();
...
public void setCc(Set<String> v) {
  ...
  protected  Set<String> bcc = new HashSet<>();
...
public void setFromMember(Member v) {
  ...
  @JsonProperty
  protected transient Set<Member> toMember = new HashSet<>();
...
public void setToMember(Set<Member> v) {
  ...
  @JsonProperty
  protected transient Set<Member> ccMember = new HashSet<>();
...
public void setCcMember(Set<Member> v) {
  ...
  @JsonProperty
  protected transient Set<Member> bccMember = new HashSet<>();
...
public void setContentHtml(String v) { contentHtml = v; }
  ...
  @JsonProperty
  protected transient Set<com.jalios.jcms.FileDocument> attachements = new HashSet<>();
...
public void setInReplyTo(String v) { inReplyTo = v; }
  ...
  protected  Set<String> references = new HashSet<>();
