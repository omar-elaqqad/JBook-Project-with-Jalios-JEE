...
// Generation date: Thu Apr 04 15:24:48 WET 2024
...
public class PortletBlog_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletBlog handler = (generated.PortletBlog)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("displayedList");
    if (value != null) {
      handler.setDisplayedList((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "displayedList")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletBlog handler = (generated.PortletBlog)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("displayedList", StoreUtil.encodeObject(handler.getDisplayedList(), store));
