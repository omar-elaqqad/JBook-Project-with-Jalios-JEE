...
public void setFieldValue(String fieldName, Object value, String lang) throws NoSuchFieldException {
  ...
  public static String[] getDisplayModeLabels(String userLang) {
    ...
    String[] labels = displayModeLabelMap.get(userLang);
    if (labels == null) {
      labels = displayModeLabelMap.get(channel.getLanguage());
    }
    return labels;
  }
  ...
  public static String[] getReverseOrderLabels(String userLang) {
    ...
    String[] labels = reverseOrderLabelMap.get(userLang);
    if (labels == null) {
      labels = reverseOrderLabelMap.get(channel.getLanguage());
    }
    return labels;
  }
  ...
  public static String[] getShowPagerLabels(String userLang) {
    ...
    String[] labels = showPagerLabelMap.get(userLang);
    if (labels == null) {
      labels = showPagerLabelMap.get(channel.getLanguage());
    }
    return labels;
  }
  ...
  public String getPagerLabel(String lang) { return channel.getLangValue(lang, true, pagerLabel, pagerLabelML, getMainLanguage()); }
  public String getPagerLabel(String lang, boolean useDefault) { return channel.getLangValue(lang, useDefault, pagerLabel, pagerLabelML, getMainLanguage()); }
