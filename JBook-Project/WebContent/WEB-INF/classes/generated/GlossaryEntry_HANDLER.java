...
// Generation date: Thu Apr 04 15:21:32 WET 2024
...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = attributes.get("definition");
    if (value != null) {
      handler.setDefinition(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "definition")));
    }

    value = attributes.get("definitionML");
    if (value != null) {
      handler.setDefinitionML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "definitionML")));
    }

    value = attributes.get("seeAlso");
    if (value != null) {
      handler.setSeeAlso(StoreUtil.decodeObject(generated.GlossaryEntry[].class, value, store, new DecodeContext(sle, "seeAlso")));
    }

    value = attributes.get("glossary");
    if (value != null) {
      handler.setGlossary(StoreUtil.decodeObject(generated.Glossary.class, value, store, new DecodeContext(sle, "glossary")));
    }
