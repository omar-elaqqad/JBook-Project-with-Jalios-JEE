...
public void setFieldValue(String fieldName, Object value, String lang) throws NoSuchFieldException {
  ...
  public static String[] getIndicatorTypeLabels(String userLang) {
    ...
    String[] labels = indicatorTypeLabelMap.get(userLang);
    if (labels == null) {
      labels = indicatorTypeLabelMap.get(channel.getLanguage());
    }
    return labels;
  }
  ...
  public String getBriefText(String lang) { return channel.getLangValue(lang, true, briefText, briefTextML, getMainLanguage()); }
  public String getBriefText(String lang, boolean useDefault) { return channel.getLangValue(lang, useDefault, briefText, briefTextML, getMainLanguage()); }
  ...
  public static String[] getLinkTypeLabels(String userLang) {
    ...
    String[] labels = linkTypeLabelMap.get(userLang);
    if (labels == null) {
      labels = linkTypeLabelMap.get(channel.getLanguage());
    }
    return labels;
  }
  ...
  public String getLinkLabel(String lang) { return channel.getLangValue(lang, true, linkLabel, linkLabelML, getMainLanguage()); }
  public String getLinkLabel(String lang, boolean useDefault) { return channel.getLangValue(lang, useDefault, linkLabel, linkLabelML, getMainLanguage()); }
