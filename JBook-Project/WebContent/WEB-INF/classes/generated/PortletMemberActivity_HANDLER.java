...
// Generation date: Fri Apr 05 09:15:18 WET 2024
...
public class PortletMemberActivity_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletMemberActivity handler = (generated.PortletMemberActivity)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("activityMode");
    if (value != null) {
      handler.setActivityMode((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "activityMode")));
    }
    ...
    value = attributes.get("showMedia");
    if (value != null) {
        handler.setShowMedia(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showComments");
    if (value != null) {
        handler.setShowComments(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("displayAllEvent");
    if (value != null) {
        handler.setDisplayAllEvent(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("filters");
    if (value != null) {
      handler.setFilters((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "filters")));
    }

    value = attributes.get("defaultPageSize");
    if (value != null) {
        try {handler.setDefaultPageSize((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletMemberActivity handler = (generated.PortletMemberActivity)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("activityMode", StoreUtil.encodeObject(handler.getActivityMode(), store));
    attributes.put("showAbstract", String.valueOf(handler.getShowAbstract()));
    attributes.put("showMedia", String.valueOf(handler.getShowMedia()));
    attributes.put("showComments", String.valueOf(handler.getShowComments()));
    attributes.put("displayAllEvent", String.valueOf(handler.getDisplayAllEvent()));
    attributes.put("filters", StoreUtil.encodeObject(handler.getFilters(), store));
    attributes.put("defaultPageSize", String.valueOf(handler.getDefaultPageSize()));
