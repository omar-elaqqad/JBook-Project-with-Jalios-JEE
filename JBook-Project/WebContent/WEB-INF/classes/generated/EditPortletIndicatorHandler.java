...
public boolean validateBeforeOp() {
    ...
    if (!validateUploadedFileDocument(getAvailablePublicationLink(),   fdauthor, getAvailableWorkspace()) || !createUploadedFileDocument(getAvailablePublicationLink(),  fdauthor, getAvailableWorkspace())) {
      return false;
    }
    return true;
  }
...
public boolean validateCreate() throws java.io.IOException {
    if (!super.validateCreate() || !validateCommonCreateUpdatePortletIndicator()) {
      return false;
    }
    return true;
  }
...
public boolean validateUpdate() throws java.io.IOException {
    if (!super.validateUpdate() || !validateCommonCreateUpdatePortletIndicator()) {
      return false;
    }
