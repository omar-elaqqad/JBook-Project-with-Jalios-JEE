...
public class PortletMenu_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletMenu handler = (generated.PortletMenu)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("items");
    if (value != null) {
      handler.setItems((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "items")));
    }

    value = attributes.get("itemSeparaor");
    if (value != null) {
      handler.setItemSeparaor((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "itemSeparaor")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletMenu handler = (generated.PortletMenu)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("items", StoreUtil.encodeObject(handler.getItems(), store));
    attributes.put("itemSeparaor", StoreUtil.encodeObject(handler.getItemSeparaor(), store));
