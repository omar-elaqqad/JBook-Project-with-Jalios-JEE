...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setItems(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "items")));
    }

    value = attributes.get("itemSeparaor");
    if (value != null) {
      handler.setItemSeparaor(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "itemSeparaor")));
    }
