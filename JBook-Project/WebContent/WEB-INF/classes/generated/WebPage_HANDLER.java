...
// Generation date: Thu Apr 04 15:21:53 WET 2024
...
public class WebPage_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = attributes.get("urlToShot");
    if (value != null) {
      handler.setUrlToShot((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "urlToShot")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.WebPage handler = (generated.WebPage)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("url", StoreUtil.encodeObject(handler.getUrl(), store));
    attributes.put("urlToShot", StoreUtil.encodeObject(handler.getUrlToShot(), store));
