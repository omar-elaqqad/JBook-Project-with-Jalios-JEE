...
public boolean validateBeforeOp() {
  ...
  public Object getEnumValues(String field) {
    ...
    if ("cacheSensibility".equals(field)) {
      return AbstractPortletSkinable.getCacheSensibilityValues();
    }
    if ("invalidClass".equals(field)) {
      return AbstractPortletSkinable.getInvalidClassValues();
    }
    if ("displayCSS".equals(field)) {
      return AbstractPortletSkinable.getDisplayCSSValues();
    }
    if ("alignH".equals(field)) {
      return AbstractPortletSkinable.getAlignHValues();
    }
    if ("alignV".equals(field)) {
      return AbstractPortletSkinable.getAlignVValues();
    }
    if ("alignTable".equals(field)) {
      return AbstractPortletSkinable.getAlignTableValues();
    }
    if ("skinCSS".equals(field)) {
      return AbstractPortletSkinable.getSkinCSSValues();
    }
    if ("popupState".equals(field)) {
      return AbstractPortletSkinable.getPopupStateValues();
    }
    if ("expandState".equals(field)) {
      return AbstractPortletSkinable.getExpandStateValues();
    }
    if ("behaviorCopy".equals(field)) {
      return AbstractPortletSkinable.getBehaviorCopyValues();
    }
    if ("condition".equals(field)) {
      return AbstractPortletSkinable.getConditionValues();
    }
    if ("skinFooterButtonAlign".equals(field)) {
      return AbstractPortletSkinable.getSkinFooterButtonAlignValues();
    }
  ...
  public Object getEnumLabels(String field, String userLang) {
    ...
    if ("cacheSensibility".equals(field)) {
      return AbstractPortletSkinable.getCacheSensibilityLabels(userLang);
    }
    if ("invalidClass".equals(field)) {
      return AbstractPortletSkinable.getInvalidClassLabels(userLang);
    }
    if ("displayCSS".equals(field)) {
      return AbstractPortletSkinable.getDisplayCSSLabels(userLang);
    }
    if ("alignH".equals(field)) {
      return AbstractPortletSkinable.getAlignHLabels(userLang);
    }
    if ("alignV".equals(field)) {
      return AbstractPortletSkinable.getAlignVLabels(userLang);
    }
    if ("alignTable".equals(field)) {
      return AbstractPortletSkinable.getAlignTableLabels(userLang);
    }
    if ("skinCSS".equals(field)) {
      return AbstractPortletSkinable.getSkinCSSLabels(userLang);
    }
    if ("popupState".equals(field)) {
      return AbstractPortletSkinable.getPopupStateLabels(userLang);
    }
    if ("expandState".equals(field)) {
      return AbstractPortletSkinable.getExpandStateLabels(userLang);
    }
    if ("behaviorCopy".equals(field)) {
      return AbstractPortletSkinable.getBehaviorCopyLabels(userLang);
    }
    if ("condition".equals(field)) {
      return AbstractPortletSkinable.getConditionLabels(userLang);
    }
    if ("skinFooterButtonAlign".equals(field)) {
      return AbstractPortletSkinable.getSkinFooterButtonAlignLabels(userLang);
    }
...
public String getAvailableDescription(String lang) {
  ...
  public String getAvailablePortletImage(String lang) {
    if (theContent != null) {
      if (lang.equals(channel.getLanguage())) {
      	if (!Util.isSameContent(portletImage, channel.getTypeFieldEntry(AbstractPortletSkinable.class, "portletImage", true).getDefaultTextString())) {
          return portletImage;
      	}
      } else {
...
public HashMap<String,String> getAllAvailableSkinFooterML() {
  ...
  public String getAvailableSkinFooter(String lang) {
    if (theContent != null) {
      if (lang.equals(channel.getLanguage())) {
      	if (!Util.isSameContent(skinFooter, channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinFooter", true).getDefaultTextString())) {
          return skinFooter;
      	}
      } else {
...
public HashMap<String,String> getAllAvailableSkinFooterButtonLabelML() {
  ...
  public String getAvailableSkinFooterButtonLabel(String lang) {
    if (theContent != null) {
      if (lang.equals(channel.getLanguage())) {
      	if (!Util.isSameContent(skinFooterButtonLabel, channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinFooterButtonLabel", true).getDefaultTextString())) {
          return skinFooterButtonLabel;
      	}
      } else {
...
public HashMap<String,String> getAllAvailableSkinHeaderButtonLabelML() {
  ...
  public String getAvailableSkinHeaderButtonLabel(String lang) {
    if (theContent != null) {
      if (lang.equals(channel.getLanguage())) {
      	if (!Util.isSameContent(skinHeaderButtonLabel, channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinHeaderButtonLabel", true).getDefaultTextString())) {
          return skinHeaderButtonLabel;
      	}
      } else {
