...
public class PortletMyLocks_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletMyLocks handler = (generated.PortletMyLocks)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("refineWorkspace", String.valueOf(handler.getRefineWorkspace()));
