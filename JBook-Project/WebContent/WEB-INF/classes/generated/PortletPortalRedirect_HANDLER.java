...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    ...
    attributes.put("redirectForm", StoreUtil.encodeObject(handler.getRedirectForm(), store));
    attributes.put("url", StoreUtil.encodeObject(handler.getUrl(), store));
    attributes.put("urlML", StoreUtil.encodeObject(handler.getUrlML(), store));
    attributes.put("redirectPortlet", StoreUtil.encodeObject(handler.getRedirectPortlet(), store));
    attributes.put("category", StoreUtil.encodeObject(handler.getCategory(), store));
    attributes.put("dispPortal", StoreUtil.encodeObject(handler.getDispPortal(), store));
