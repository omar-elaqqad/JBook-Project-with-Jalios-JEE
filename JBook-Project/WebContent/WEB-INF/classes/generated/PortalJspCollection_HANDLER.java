...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setJsp(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "jsp")));
    }
    ...
    if (value != null) {
      handler.setChild(StoreUtil.decodeObject(com.jalios.jcms.portlet.PortalElement.class, value, store, new DecodeContext(sle, "child")));
    }

    value = attributes.get("cssFile");
    if (value != null) {
      handler.setCssFile(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cssFile")));
    }
