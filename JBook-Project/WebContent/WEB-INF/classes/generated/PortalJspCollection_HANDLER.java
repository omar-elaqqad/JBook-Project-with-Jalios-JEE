...
public class PortalJspCollection_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortalJspCollection handler = (generated.PortalJspCollection)storable;
    String value;
    ...
    value = attributes.get("jsp");
    if (value != null) {
      handler.setJsp((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "jsp")));
    }
    ...
    value = attributes.get("child");
    if (value != null) {
      handler.setChild((com.jalios.jcms.portlet.PortalElement)StoreUtil.decodeObject(com.jalios.jcms.portlet.PortalElement.class, value, store, new DecodeContext(sle, "child")));
    }

    value = attributes.get("cssFile");
    if (value != null) {
      handler.setCssFile((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "cssFile")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortalJspCollection handler = (generated.PortalJspCollection)storable;
    ...
    attributes.put("jsp", StoreUtil.encodeObject(handler.getJsp(), store));
    ...
    attributes.put("child", StoreUtil.encodeObject(handler.getChild(), store));
    attributes.put("cssFile", StoreUtil.encodeObject(handler.getCssFile(), store));
