...
// Generation date: Fri Apr 05 09:15:19 WET 2024
...
public class PortletMemberProfile_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletMemberProfile handler = (generated.PortletMemberProfile)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("showSuggestions");
    if (value != null) {
        handler.setShowSuggestions(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showConnectionRequests");
    if (value != null) {
        handler.setShowConnectionRequests(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletMemberProfile handler = (generated.PortletMemberProfile)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("showSuggestions", String.valueOf(handler.getShowSuggestions()));
    attributes.put("showConnectionRequests", String.valueOf(handler.getShowConnectionRequests()));
