...
public class PortletLogin_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setLoginText((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "loginText")));
    }

    value = attributes.get("loginTextML");
    if (value != null) {
      handler.setLoginTextML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "loginTextML")));
    }

    value = attributes.get("passwordText");
    if (value != null) {
      handler.setPasswordText((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "passwordText")));
    }

    value = attributes.get("passwordTextML");
    if (value != null) {
      handler.setPasswordTextML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "passwordTextML")));
    }

    value = attributes.get("buttonText");
    if (value != null) {
      handler.setButtonText((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "buttonText")));
    }

    value = attributes.get("buttonTextML");
    if (value != null) {
      handler.setButtonTextML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "buttonTextML")));
    }

    value = attributes.get("displayPortal");
    if (value != null) {
      handler.setDisplayPortal((generated.PortletPortal)StoreUtil.decodeObject(generated.PortletPortal.class, value, store, new DecodeContext(sle, "displayPortal")));
    }
