...
public class Glossary_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    Glossary handler = (generated.Glossary)storable;
    String value;
    ...
    value = attributes.get("displayFirstLetter");
    if (value != null) {
        handler.setDisplayFirstLetter(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.Glossary handler = (generated.Glossary)storable;
    ...
    attributes.put("displayFirstLetter", String.valueOf(handler.getDisplayFirstLetter()));
