...
// Generation date: Thu Apr 04 15:21:40 WET 2024
...
public class PortletLoggedMembers_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletLoggedMembers handler = (generated.PortletLoggedMembers)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("limitPortletAccess");
    if (value != null) {
        handler.setLimitPortletAccess(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("displayNumbers");
    if (value != null) {
        handler.setDisplayNumbers(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("displayMembers");
    if (value != null) {
      handler.setDisplayMembers((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "displayMembers")));
    }

    value = attributes.get("displayLinkToMembersProfile");
    if (value != null) {
        handler.setDisplayLinkToMembersProfile(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("maximumMembers");
    if (value != null) {
        try {handler.setMaximumMembers((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletLoggedMembers handler = (generated.PortletLoggedMembers)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("limitPortletAccess", String.valueOf(handler.getLimitPortletAccess()));
    attributes.put("displayNumbers", String.valueOf(handler.getDisplayNumbers()));
    attributes.put("displayMembers", StoreUtil.encodeObject(handler.getDisplayMembers(), store));
    attributes.put("displayLinkToMembersProfile", String.valueOf(handler.getDisplayLinkToMembersProfile()));
    attributes.put("maximumMembers", String.valueOf(handler.getMaximumMembers()));
