...
public class PortletPublication_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletPublication handler = (generated.PortletPublication)storable;
    String value;
    ...
    value = attributes.get("template");
    if (value != null) {
      handler.setTemplate((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "template")));
    }

    value = attributes.get("showDisplayHeader");
    if (value != null) {
        handler.setShowDisplayHeader(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("showDisplayFooter");
    if (value != null) {
        handler.setShowDisplayFooter(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletPublication handler = (generated.PortletPublication)storable;
    ...
    attributes.put("template", StoreUtil.encodeObject(handler.getTemplate(), store));
    attributes.put("showDisplayHeader", String.valueOf(handler.getShowDisplayHeader()));
    attributes.put("showDisplayFooter", String.valueOf(handler.getShowDisplayFooter()));
