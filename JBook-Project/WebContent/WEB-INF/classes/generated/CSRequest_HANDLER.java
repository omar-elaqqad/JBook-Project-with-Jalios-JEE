...
public class CSRequest_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setNameML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "nameML")));
    }
    ...
    if (value != null) {
      handler.setModel((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "model")));
    }

    value = attributes.get("language");
    if (value != null) {
      handler.setLanguage((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "language")));
    }

    value = attributes.get("admins");
    if (value != null) {
      handler.setAdmins((com.jalios.jcms.Member[])StoreUtil.decodeObject(com.jalios.jcms.Member[].class, value, store, new DecodeContext(sle, "admins")));
    }

    value = attributes.get("adminsDBID");
    if (value != null) {
      handler.setAdminsDBID((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "adminsDBID")));
    }

    value = attributes.get("groups");
    if (value != null) {
      handler.setGroups((com.jalios.jcms.Group[])StoreUtil.decodeObject(com.jalios.jcms.Group[].class, value, store, new DecodeContext(sle, "groups")));
    }

    value = attributes.get("members");
    if (value != null) {
      handler.setMembers((com.jalios.jcms.Member[])StoreUtil.decodeObject(com.jalios.jcms.Member[].class, value, store, new DecodeContext(sle, "members")));
    }

    value = attributes.get("membersDBID");
    if (value != null) {
      handler.setMembersDBID((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "membersDBID")));
    }

    value = attributes.get("notificationPolicy");
    if (value != null) {
      handler.setNotificationPolicy((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "notificationPolicy")));
    }

    value = attributes.get("parent");
    if (value != null) {
      handler.setParent((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "parent")));
    }
