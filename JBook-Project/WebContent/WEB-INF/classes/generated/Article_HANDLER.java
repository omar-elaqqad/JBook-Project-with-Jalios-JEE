...
public class Article_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setPictureML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "pictureML")));
    }

    value = attributes.get("pictureAlt");
    if (value != null) {
      handler.setPictureAlt((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "pictureAlt")));
    }

    value = attributes.get("pictureAltML");
    if (value != null) {
      handler.setPictureAltML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "pictureAltML")));
    }

    value = attributes.get("content");
    if (value != null) {
      handler.setContent((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "content")));
    }

    value = attributes.get("contentML");
    if (value != null) {
      handler.setContentML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "contentML")));
    }

    value = attributes.get("relatedContents");
    if (value != null) {
      handler.setRelatedContents((com.jalios.jcms.Content[])StoreUtil.decodeObject(com.jalios.jcms.Content[].class, value, store, new DecodeContext(sle, "relatedContents")));
    }

    value = attributes.get("relatedContentsDBID");
    if (value != null) {
      handler.setRelatedContentsDBID((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "relatedContentsDBID")));
    }
