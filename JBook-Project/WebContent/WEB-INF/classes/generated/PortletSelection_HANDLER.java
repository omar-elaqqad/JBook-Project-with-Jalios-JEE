...
public class PortletSelection_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletSelection handler = (generated.PortletSelection)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("showDisplayHeaderFooter");
    if (value != null) {
        handler.setShowDisplayHeaderFooter(Boolean.valueOf(value).booleanValue());
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletSelection handler = (generated.PortletSelection)storable;
    Map<String,String> attributes = new HashMap<>();
    attributes.put("showDisplayHeaderFooter", String.valueOf(handler.getShowDisplayHeaderFooter()));
