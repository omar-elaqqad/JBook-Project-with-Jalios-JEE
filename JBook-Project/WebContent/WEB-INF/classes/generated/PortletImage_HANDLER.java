...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setLinkML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "linkML")));
    }

    value = attributes.get("alt");
    if (value != null) {
      handler.setAlt(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "alt")));
    }

    value = attributes.get("altML");
    if (value != null) {
      handler.setAltML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "altML")));
    }

    value = attributes.get("targetWindow");
    if (value != null) {
      handler.setTargetWindow(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "targetWindow")));
    }
