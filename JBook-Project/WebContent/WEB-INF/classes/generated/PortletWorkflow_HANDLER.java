...
// Generation date: Thu Apr 04 15:21:51 WET 2024
...
public class PortletWorkflow_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletWorkflow handler = (generated.PortletWorkflow)storable;
    String value;
    ...
    value = attributes.get("maximumItemsPerWorkspace");
    if (value != null) {
        try {handler.setMaximumItemsPerWorkspace((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }
    ...
    value = attributes.get("displayCSWorkspacePublication");
    if (value != null) {
        handler.setDisplayCSWorkspacePublication(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletWorkflow handler = (generated.PortletWorkflow)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("queries", StoreUtil.encodeObject(handler.getQueries(), store));
    attributes.put("maximumItemsPerWorkspace", String.valueOf(handler.getMaximumItemsPerWorkspace()));
    ...
    attributes.put("displayCSWorkspacePublication", String.valueOf(handler.getDisplayCSWorkspacePublication()));
