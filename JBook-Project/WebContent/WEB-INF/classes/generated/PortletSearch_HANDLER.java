...
// Generation date: Thu Apr 04 15:21:48 WET 2024
...
public class PortletSearch_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletSearch handler = (generated.PortletSearch)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("titleText");
    if (value != null) {
      handler.setTitleText(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "titleText")));
    }

    value = attributes.get("titleTextML");
    if (value != null) {
      handler.setTitleTextML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "titleTextML")));
    }

    value = attributes.get("searchWith");
    if (value != null) {
      handler.setSearchWith(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "searchWith")));
    }

    value = attributes.get("searchIn");
    if (value != null) {
      handler.setSearchIn(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "searchIn")));
    }

    value = attributes.get("instantSearch");
    if (value != null) {
        handler.setInstantSearch(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("query");
    if (value != null) {
      handler.setQuery(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "query")));
    }
    ...
    value = attributes.get("queryPortlet");
    if (value != null) {
      handler.setQueryPortlet(StoreUtil.decodeObject(generated.PortletQueryForeach.class, value, store, new DecodeContext(sle, "queryPortlet")));
    }

    value = attributes.get("displayPortal");
    if (value != null) {
      handler.setDisplayPortal(StoreUtil.decodeObject(com.jalios.jcms.Publication.class, value, store, new DecodeContext(sle, "displayPortal")));
    }

    value = attributes.get("displayPortalDBID");
    if (value != null) {
      handler.setDisplayPortalDBID(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "displayPortalDBID")));
    }

    value = attributes.get("advancedSearchPortlet");
    if (value != null) {
      handler.setAdvancedSearchPortlet(StoreUtil.decodeObject(generated.PortletSearch.class, value, store, new DecodeContext(sle, "advancedSearchPortlet")));
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletSearch handler = (generated.PortletSearch)storable;
    ...
    attributes.put("searchWith", StoreUtil.encodeObject(handler.getSearchWith(), store));
    attributes.put("searchIn", StoreUtil.encodeObject(handler.getSearchIn(), store));
    attributes.put("instantSearch", String.valueOf(handler.getInstantSearch()));
    attributes.put("query", StoreUtil.encodeObject(handler.getQuery(), store));
    attributes.put("refineQueries", StoreUtil.encodeObject(handler.getRefineQueries(), store));
    attributes.put("queryPortlet", StoreUtil.encodeObject(handler.getQueryPortlet(), store));
    attributes.put("displayPortal", StoreUtil.encodeObject(handler.getDisplayPortal(), store));
    attributes.put("displayPortalDBID", StoreUtil.encodeObject(handler.getDisplayPortalDBID(), store));
    attributes.put("advancedSearchPortlet", StoreUtil.encodeObject(handler.getAdvancedSearchPortlet(), store));
