...
public class PortletSearch_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setSearchWith((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "searchWith")));
    }

    value = attributes.get("searchIn");
    if (value != null) {
      handler.setSearchIn((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "searchIn")));
    }
    ...
    if (value != null) {
      handler.setQuery((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "query")));
    }
    ...
    if (value != null) {
      handler.setQueryPortlet((generated.PortletQueryForeach)StoreUtil.decodeObject(generated.PortletQueryForeach.class, value, store, new DecodeContext(sle, "queryPortlet")));
    }

    value = attributes.get("displayPortal");
    if (value != null) {
      handler.setDisplayPortal((com.jalios.jcms.Publication)StoreUtil.decodeObject(com.jalios.jcms.Publication.class, value, store, new DecodeContext(sle, "displayPortal")));
    }

    value = attributes.get("displayPortalDBID");
    if (value != null) {
      handler.setDisplayPortalDBID((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "displayPortalDBID")));
    }

    value = attributes.get("advancedSearchPortlet");
    if (value != null) {
      handler.setAdvancedSearchPortlet((generated.PortletSearch)StoreUtil.decodeObject(generated.PortletSearch.class, value, store, new DecodeContext(sle, "advancedSearchPortlet")));
    }
