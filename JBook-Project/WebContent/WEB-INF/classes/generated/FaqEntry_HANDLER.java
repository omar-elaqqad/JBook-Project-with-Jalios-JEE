...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setAnswer(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "answer")));
    }

    value = attributes.get("answerML");
    if (value != null) {
      handler.setAnswerML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "answerML")));
    }

    value = attributes.get("faq");
    if (value != null) {
      handler.setFaq(StoreUtil.decodeObject(generated.Faq.class, value, store, new DecodeContext(sle, "faq")));
    }
