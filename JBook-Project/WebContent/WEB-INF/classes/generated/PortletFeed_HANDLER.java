...
// Generation date: Thu Apr 04 15:21:36 WET 2024
...
public class PortletFeed_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletFeed handler = (generated.PortletFeed)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("formats");
    if (value != null) {
      handler.setFormats((java.lang.String[])StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "formats")));
    }

    value = attributes.get("copyright");
    if (value != null) {
      handler.setCopyright((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "copyright")));
    }

    value = attributes.get("copyrightML");
    if (value != null) {
      handler.setCopyrightML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "copyrightML")));
    }

    value = attributes.get("useAuthKey");
    if (value != null) {
        handler.setUseAuthKey(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletFeed handler = (generated.PortletFeed)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("formats", StoreUtil.encodeObject(handler.getFormats(), store));
    attributes.put("copyright", StoreUtil.encodeObject(handler.getCopyright(), store));
    attributes.put("copyrightML", StoreUtil.encodeObject(handler.getCopyrightML(), store));
    attributes.put("useAuthKey", String.valueOf(handler.getUseAuthKey()));
