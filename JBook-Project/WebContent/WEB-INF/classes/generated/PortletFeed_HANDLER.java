...
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    if (value != null) {
      handler.setFormats(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "formats")));
    }

    value = attributes.get("copyright");
    if (value != null) {
      handler.setCopyright(StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "copyright")));
    }

    value = attributes.get("copyrightML");
    if (value != null) {
      handler.setCopyrightML(StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "copyrightML")));
    }
