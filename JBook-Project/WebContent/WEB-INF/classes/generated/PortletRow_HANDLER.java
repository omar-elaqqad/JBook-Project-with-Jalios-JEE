...
public class PortletRow_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletRow handler = (generated.PortletRow)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("rowSpacing");
    if (value != null) {
        try {handler.setRowSpacing((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("cellWidth");
    if (value != null) {
      handler.setCellWidth(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "cellWidth")));
    }

    value = attributes.get("alignHorizontal");
    if (value != null) {
      handler.setAlignHorizontal(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "alignHorizontal")));
    }

    value = attributes.get("alignVertical");
    if (value != null) {
      handler.setAlignVertical(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "alignVertical")));
    }

    value = attributes.get("backgroundColor");
    if (value != null) {
      handler.setBackgroundColor(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "backgroundColor")));
    }

    value = attributes.get("backgroundImage");
    if (value != null) {
      handler.setBackgroundImage(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "backgroundImage")));
    }

    value = attributes.get("backgroundRepeat");
    if (value != null) {
      handler.setBackgroundRepeat(StoreUtil.decodeObject(java.lang.String[].class, value, store, new DecodeContext(sle, "backgroundRepeat")));
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletRow handler = (generated.PortletRow)storable;
    Map<String,String> attributes = new HashMap<>();
    attributes.put("rowSpacing", String.valueOf(handler.getRowSpacing()));
    attributes.put("cellWidth", StoreUtil.encodeObject(handler.getCellWidth(), store));
