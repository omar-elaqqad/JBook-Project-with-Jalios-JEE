...
// Generation date: Thu Apr 04 15:21:42 WET 2024
...
public class PortletNavigate_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletNavigate handler = (generated.PortletNavigate)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("refineCategory");
    if (value != null) {
      handler.setRefineCategory((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "refineCategory")));
    }

    value = attributes.get("levels");
    if (value != null) {
        try {handler.setLevels((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }
    ...
    value = attributes.get("navigatePortlet");
    if (value != null) {
        handler.setNavigatePortlet(Boolean.valueOf(value).booleanValue());
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletNavigate handler = (generated.PortletNavigate)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("refineCategory", StoreUtil.encodeObject(handler.getRefineCategory(), store));
    attributes.put("levels", String.valueOf(handler.getLevels()));
    attributes.put("hideWhenNoResults", String.valueOf(handler.getHideWhenNoResults()));
    attributes.put("navigatePortlet", String.valueOf(handler.getNavigatePortlet()));
