...
public class PortletCollaborativeSpaceSuggestion_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletCollaborativeSpaceSuggestion handler = (generated.PortletCollaborativeSpaceSuggestion)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("threshold");
    if (value != null) {
        try {handler.setThreshold((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletCollaborativeSpaceSuggestion handler = (generated.PortletCollaborativeSpaceSuggestion)storable;
    Map<String,String> attributes = new HashMap<>();
    attributes.put("threshold", String.valueOf(handler.getThreshold()));
