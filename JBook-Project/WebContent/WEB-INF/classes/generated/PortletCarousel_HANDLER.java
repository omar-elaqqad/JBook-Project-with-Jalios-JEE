...
// Generation date: Thu Apr 04 15:21:34 WET 2024
...
public class PortletCarousel_HANDLER implements com.jalios.jstore.StorableHandler {

  @SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletCarousel handler = (generated.PortletCarousel)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("autoplaycarousel");
    if (value != null) {
        try {handler.setAutoplaycarousel((Long.valueOf(value)).longValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("arrows");
    if (value != null) {
        handler.setArrows(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("dots");
    if (value != null) {
        handler.setDots(Boolean.valueOf(value).booleanValue());
    }
    ...
    if (value != null) {
        handler.setShowDate(Boolean.valueOf(value).booleanValue());
    }
    ...
    value = attributes.get("slidesToShow");
    if (value != null) {
        try {handler.setSlidesToShow((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = attributes.get("numberOfLinesInTheTitle");
    if (value != null) {
      handler.setNumberOfLinesInTheTitle((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "numberOfLinesInTheTitle")));
    }
  ...
  public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletCarousel handler = (generated.PortletCarousel)storable;
    Map<String,String> attributes = new HashMap<String,String>();
    attributes.put("autoplaycarousel", String.valueOf(handler.getAutoplaycarousel()));
    attributes.put("arrows", String.valueOf(handler.getArrows()));
    attributes.put("dots", String.valueOf(handler.getDots()));
    attributes.put("showTitle", String.valueOf(handler.getShowTitle()));
    attributes.put("showDate", String.valueOf(handler.getShowDate()));
    attributes.put("showAuthor", String.valueOf(handler.getShowAuthor()));
    attributes.put("slidesToShow", String.valueOf(handler.getSlidesToShow()));
    attributes.put("numberOfLinesInTheTitle", StoreUtil.encodeObject(handler.getNumberOfLinesInTheTitle(), store));
