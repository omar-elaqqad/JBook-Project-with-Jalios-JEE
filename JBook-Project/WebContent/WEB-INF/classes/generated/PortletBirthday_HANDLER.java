...
public class PortletBirthday_HANDLER implements com.jalios.jstore.StorableHandler {

  @Override
@SuppressWarnings("rawtypes")
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletBirthday handler = (generated.PortletBirthday)storable;
    String value;
    Map<String,String> attributes = sle.getAttributes();
    value = attributes.get("workspaceMembers");
    if (value != null) {
        handler.setWorkspaceMembers(Boolean.valueOf(value).booleanValue());
    }

    value = attributes.get("relationshipFilter");
    if (value != null) {
        handler.setRelationshipFilter(Boolean.valueOf(value).booleanValue());
    }
...
public Map<String,String> getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletBirthday handler = (generated.PortletBirthday)storable;
    Map<String,String> attributes = new HashMap<>();
    attributes.put("workspaceMembers", String.valueOf(handler.getWorkspaceMembers()));
    attributes.put("relationshipFilter", String.valueOf(handler.getRelationshipFilter()));
