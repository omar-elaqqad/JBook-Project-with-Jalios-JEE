...
<div class="fullDisplay PortletRSS <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>" itemscope="itemscope">
...
<table class="fields">
  ...
  <tr class="field sortAttribute enumerateEditor  <%= Util.isEmpty(obj.getSortAttribute()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "sortAttribute", userLang) %></td>
    <td class='field-data' <%= gfla(obj, "sortAttribute") %>>
            <% if (Util.notEmpty(obj.getSortAttribute())) { %>
            <%= obj.getSortAttributeLabel(obj.getSortAttribute(), userLang) %>
            <% } %>
    </td>
  </tr>
  ...
  <tr class="field skinFooter wysiwygEditor  <%= Util.isEmpty(obj.getSkinFooter(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinFooter", userLang) %></td>
  ...
  <tr class="field skinHeaderIcon textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderIcon()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinHeaderIcon", userLang) %></td>
  ...
  <tr class="field skinHeaderIconColor textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderIconColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinHeaderIconColor", userLang) %></td>
  ...
  <tr class="field skinFooterButtonLabel textfieldEditor  <%= Util.isEmpty(obj.getSkinFooterButtonLabel(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinFooterButtonLabel", userLang) %></td>
  ...
  <tr class="field skinFooterButtonLink urlEditor  <%= Util.isEmpty(obj.getSkinFooterButtonLink()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinFooterButtonLink", userLang) %></td>
  ...
  <tr class="field skinFooterButtonAlign enumerateEditor  <%= Util.isEmpty(obj.getSkinFooterButtonAlign()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinFooterButtonAlign", userLang) %></td>
  ...
  <tr class="field skinHeaderButtonLabel textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderButtonLabel(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinHeaderButtonLabel", userLang) %></td>
  ...
  <tr class="field skinHeaderButtonLink urlEditor  <%= Util.isEmpty(obj.getSkinHeaderButtonLink()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinHeaderButtonLink", userLang) %></td>
  ...
  <tr class="field skinHeaderSubText textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderSubText(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletRSS.class, "skinHeaderSubText", userLang) %></td>
