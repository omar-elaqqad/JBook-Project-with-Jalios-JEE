...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditCollaborativeSpaceHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/CollaborativeSpace/editCollaborativeSpaceModal.jsp">
<div class="row CollaborativeSpace">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/CollaborativeSpace/doEditCollaborativeSpaceModal.jsp" />
</div>
</jalios:modal>
<% 
