...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td><%= Util.getString(newObj.getSyncMode(), "") %></td>
    <td><%= Util.getString(oldObj.getSyncMode(), "") %></td>
  </tr>
  </jalios:if>
  <%-- ** modelSyncMode ***************** --%>
  ...
  <tr class="vTop">
    ...
    <td><%= Util.getString(newObj.getModelSyncMode(), "") %></td>
    <td><%= Util.getString(oldObj.getModelSyncMode(), "") %></td>
  </tr>
  </jalios:if>
  <%-- ** model ***************** --%>
