...
<%--
  @Summary: generated.PortletJspCollection diff page
  @Category: Generated
...
<% 
{ 
generated.PortletJspCollection newObj = (generated.PortletJspCollection)request.getAttribute("newPub"); 
generated.PortletJspCollection oldObj = (generated.PortletJspCollection)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletJspCollection.class);
...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.PortletJspCollection.class, "jsp", userLang) %>
    </td>
    <% 
      request.setAttribute("fieldDomId", fieldDomId);
      request.setAttribute("step", "action");
