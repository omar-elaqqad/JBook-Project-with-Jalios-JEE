...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletPortal/editPortletPortalModal.jsp">
<div class="row PortletPortal">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletPortal/doEditPortletPortalModal.jsp" />
</div>
</jalios:modal>
<% 
