...
<%--
  @Summary: generated.PortletPortal diff page
  @Category: Generated
...
<% 
{ 
generated.PortletPortal newObj = (generated.PortletPortal)request.getAttribute("newPub"); 
generated.PortletPortal oldObj = (generated.PortletPortal)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletPortal.class);
...
%>
<jsp:include page="/types/AbstractPortal/doAbstractPortalDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
