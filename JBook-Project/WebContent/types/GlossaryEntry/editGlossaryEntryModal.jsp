...
%><% formHandler.prepare(); %>
<jalios:modal title ='<%= Util.notEmpty(formHandler.getPublication()) ? "ui.glossary.modal.edit-entry.title" : "ui.glossary.modal.add-entry.title" %>' formHandler="<%= formHandler %>" url="types/GlossaryEntry/editGlossaryEntryModal.jsp">
<div class="row GlossaryEntry">
	...
	<% } %>
	<jalios:include jsp="types/GlossaryEntry/doEditGlossaryEntryModal.jsp" />
</div>
</jalios:modal>
<% 
