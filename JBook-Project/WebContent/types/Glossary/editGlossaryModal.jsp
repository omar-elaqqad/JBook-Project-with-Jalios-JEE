...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditGlossaryHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/Glossary/editGlossaryModal.jsp">
<div class="row Glossary">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/Glossary/doEditGlossaryModal.jsp" />
</div>
</jalios:modal>
<% 
