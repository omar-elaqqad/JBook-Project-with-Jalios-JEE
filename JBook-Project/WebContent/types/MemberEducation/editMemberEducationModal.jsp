...
%><%--
  @Summary: MemberEducation editor
  @Category: Generated
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/MemberEducation/editMemberEducationModal.jsp">
<div class="row MemberEducation">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/MemberEducation/doEditMemberEducationModal.jsp" />
</div>
</jalios:modal>
<% 
