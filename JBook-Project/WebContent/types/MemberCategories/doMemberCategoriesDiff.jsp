...
<%--
  @Summary: generated.MemberCategories diff page
  @Category: Generated
...
<% 
{ 
generated.MemberCategories newObj = (generated.MemberCategories)request.getAttribute("newPub"); 
generated.MemberCategories oldObj = (generated.MemberCategories)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.MemberCategories.class);
