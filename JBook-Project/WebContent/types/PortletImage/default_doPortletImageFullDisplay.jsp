...
<div class="fullDisplay PortletImage <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>" itemscope="itemscope">
...
<table class="fields">
  ...
  <tr class="field link urlEditor  <%= Util.isEmpty(obj.getLink(userLang)) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "link") %>>
            <% if (Util.notEmpty(obj.getLink(userLang))) { %>
  ...
  <tr class="field alt textfieldEditor abstract <%= Util.isEmpty(obj.getAlt(userLang)) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "alt") %>>
            <% if (Util.notEmpty(obj.getAlt(userLang))) { %>
            <%= obj.getAlt(userLang) %>
            <% } %>
    </td>
  </tr>
  <tr class="field targetWindow enumerateEditor  <%= Util.isEmpty(obj.getTargetWindow()) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "targetWindow") %>>
            <% if (Util.notEmpty(obj.getTargetWindow())) { %>
  ...
  <tr class="field skinFooter wysiwygEditor  <%= Util.isEmpty(obj.getSkinFooter(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinFooter", userLang) %></td>
  ...
  <tr class="field skinHeaderIcon textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderIcon()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinHeaderIcon", userLang) %></td>
  ...
  <tr class="field skinHeaderIconColor textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderIconColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinHeaderIconColor", userLang) %></td>
  ...
  <tr class="field skinFooterButtonLabel textfieldEditor  <%= Util.isEmpty(obj.getSkinFooterButtonLabel(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinFooterButtonLabel", userLang) %></td>
  ...
  <tr class="field skinFooterButtonLink urlEditor  <%= Util.isEmpty(obj.getSkinFooterButtonLink()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinFooterButtonLink", userLang) %></td>
  ...
  <tr class="field skinFooterButtonAlign enumerateEditor  <%= Util.isEmpty(obj.getSkinFooterButtonAlign()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinFooterButtonAlign", userLang) %></td>
  ...
  <tr class="field skinHeaderButtonLabel textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderButtonLabel(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinHeaderButtonLabel", userLang) %></td>
  ...
  <tr class="field skinHeaderButtonLink urlEditor  <%= Util.isEmpty(obj.getSkinHeaderButtonLink()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinHeaderButtonLink", userLang) %></td>
  ...
  <tr class="field skinHeaderSubText textfieldEditor  <%= Util.isEmpty(obj.getSkinHeaderSubText(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletImage.class, "skinHeaderSubText", userLang) %></td>
