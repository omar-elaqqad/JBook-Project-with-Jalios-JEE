...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletImageHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletImage/editPortletImageModal.jsp">
<div class="row PortletImage">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletImage/doEditPortletImageModal.jsp" />
</div>
</jalios:modal>
<% 
