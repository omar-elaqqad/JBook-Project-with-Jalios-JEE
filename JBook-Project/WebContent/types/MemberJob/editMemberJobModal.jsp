...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/MemberJob/editMemberJobModal.jsp">
<div class="row MemberJob">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/MemberJob/doEditMemberJobModal.jsp" />
</div>
</jalios:modal>
<% 
