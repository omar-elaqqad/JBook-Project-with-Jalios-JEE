...
<%--
  @Summary: CSSignupRequest report page
  @Category: Generated
...
<% 
SortedSet tmpResultSet = channel.getPublicationSet(CSSignupRequest.class, loggedMember, false);
...
%>
<p class='t1'><%= channel.getTypeLabel(CSSignupRequest.class, userLang) %></p>
<%-- --- Summary ---------------------------------------------------------------------- --%>
