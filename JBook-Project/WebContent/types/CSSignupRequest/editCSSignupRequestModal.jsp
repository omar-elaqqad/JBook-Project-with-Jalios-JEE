...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/CSSignupRequest/editCSSignupRequestModal.jsp">
<div class="row CSSignupRequest">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/CSSignupRequest/doEditCSSignupRequestModal.jsp" />
</div>
</jalios:modal>
<% 
