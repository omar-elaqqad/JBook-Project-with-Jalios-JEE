...
<%--
  @Summary: CSSignupRequest editor
  @Category: Generated
...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(CSSignupRequest.class).getLabelMap()); %>
<jsp:useBean id='formHandler' scope='page' class='generated.EditCSSignupRequestHandler'>
...
<jsp:include page="doEditCSSignupRequest.jsp" />
<tr>
