...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletJspHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletJsp/editPortletJspModal.jsp">
<div class="row PortletJsp">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletJsp/doEditPortletJspModal.jsp" />
</div>
</jalios:modal>
<% 
