...
<%--
  @Summary: generated.PortletJsp diff page
  @Category: Generated
...
<% 
{ 
generated.PortletJsp newObj = (generated.PortletJsp)request.getAttribute("newPub"); 
generated.PortletJsp oldObj = (generated.PortletJsp)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletJsp.class);
...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.PortletJsp.class, "jsp", userLang) %>
    </td>
    <% 
      request.setAttribute("fieldDomId", fieldDomId);
      request.setAttribute("step", "action");
