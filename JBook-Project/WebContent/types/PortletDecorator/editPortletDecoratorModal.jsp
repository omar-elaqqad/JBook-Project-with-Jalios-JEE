...
%><%--
  @Summary: PortletDecorator editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletDecoratorHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletDecorator/editPortletDecoratorModal.jsp">
<div class="row PortletDecorator">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletDecorator/doEditPortletDecoratorModal.jsp" />
</div>
</jalios:modal>
<% 
