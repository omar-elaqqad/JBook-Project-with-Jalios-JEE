...
<%--
  @Summary: generated.PortletDecorator diff page
  @Category: Generated
...
<% 
{ 
generated.PortletDecorator newObj = (generated.PortletDecorator)request.getAttribute("newPub"); 
generated.PortletDecorator oldObj = (generated.PortletDecorator)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletDecorator.class);
...
%>
<jsp:include page="/types/AbstractParent/doAbstractParentDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
