...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditMicroBloggingHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/MicroBlogging/editMicroBloggingModal.jsp">
<div class="row MicroBlogging">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/MicroBlogging/doEditMicroBloggingModal.jsp" />
</div>
</jalios:modal>
<% 
