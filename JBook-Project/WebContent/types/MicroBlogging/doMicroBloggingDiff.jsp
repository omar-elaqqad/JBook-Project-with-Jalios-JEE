...
<%--
  @Summary: generated.MicroBlogging diff page
  @Category: Generated
...
<% 
{ 
generated.MicroBlogging newObj = (generated.MicroBlogging)request.getAttribute("newPub"); 
generated.MicroBlogging oldObj = (generated.MicroBlogging)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.MicroBlogging.class);
...
<% } %>
  ...
  <%-- ** text ***************** --%>
  <jalios:if predicate='<%= !Util.isSameContent(newObj.getText(), oldObj.getText()) %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <% fieldDomId = "textDiffDomId"; %>
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.MicroBlogging.class, "text", userLang) %>
    </td>
    <% 
      request.setAttribute("fieldDomId", fieldDomId);
      request.setAttribute("step", "action");
    ...
    <%
    {
    String newText = newObj.getText() == null ? "" : Util.toWordLine(newObj.getText());
    String oldText = oldObj.getText() == null ? "" : Util.toWordLine(oldObj.getText());
