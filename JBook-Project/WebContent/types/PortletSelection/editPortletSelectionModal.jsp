...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletSelection/editPortletSelectionModal.jsp">
<div class="row PortletSelection">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletSelection/doEditPortletSelectionModal.jsp" />
</div>
</jalios:modal>
<% 
