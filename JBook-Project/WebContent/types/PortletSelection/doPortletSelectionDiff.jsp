...
<%--
  @Summary: generated.PortletSelection diff page
  @Category: Generated
...
<% 
{ 
generated.PortletSelection newObj = (generated.PortletSelection)request.getAttribute("newPub"); 
generated.PortletSelection oldObj = (generated.PortletSelection)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletSelection.class);
...
<% } %>
  ...
  <jalios:if predicate='<%= newObj.getShowDisplayHeaderFooter() != oldObj.getShowDisplayHeaderFooter() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletSelection.class, "showDisplayHeaderFooter", userLang) %></td>
    <td><%= newObj.getShowDisplayHeaderFooterLabel(userLang) %></td>
    <td><%= oldObj.getShowDisplayHeaderFooterLabel(userLang) %></td>
  </tr>
  </jalios:if>
<%
