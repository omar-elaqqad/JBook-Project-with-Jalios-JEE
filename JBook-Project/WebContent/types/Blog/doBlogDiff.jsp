...
<%--
  @Summary: generated.Blog diff page
  @Category: Generated
...
<% 
{ 
generated.Blog newObj = (generated.Blog)request.getAttribute("newPub"); 
generated.Blog oldObj = (generated.Blog)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.Blog.class);
...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.Blog.class, "description", userLang) %>
    </td>
    <% 
      request.setAttribute("fieldDomId", fieldDomId);
      request.setAttribute("step", "action");
  ...
  <%-- ** bloggerGroup ***************** --%>
  <jalios:if predicate='<%= newObj.getBloggerGroup() != oldObj.getBloggerGroup() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.Blog.class, "bloggerGroup", userLang) %></td>
    <td>
      <% Data newLink = newObj.getBloggerGroup(); %>
      <% if (newLink != null) { %> 
    ...
    <td>
      <% Data oldLink = oldObj.getBloggerGroup(); %>
      <% if (oldLink != null) { %> 
