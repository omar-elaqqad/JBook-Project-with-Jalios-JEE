...
%><%--
  @Summary: PortletLoggedMembers editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletLoggedMembersHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletLoggedMembers/editPortletLoggedMembersModal.jsp">
<div class="row PortletLoggedMembers">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletLoggedMembers/doEditPortletLoggedMembersModal.jsp" />
</div>
</jalios:modal>
<% 
