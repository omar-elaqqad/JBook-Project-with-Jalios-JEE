...
<%--
  @Summary: generated.SmallNews diff page
  @Category: Generated
...
<% 
{ 
generated.SmallNews newObj = (generated.SmallNews)request.getAttribute("newPub"); 
generated.SmallNews oldObj = (generated.SmallNews)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.SmallNews.class);
...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.SmallNews.class, "intro", userLang) %>
      <jalios:if predicate='<%= channel.isMultilingual() %>'><jalios:lang lang='<%= itLang %>'/></jalios:if>
      <% fieldDomId += "_" + itLang; %>
    </td>
    <% 
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.SmallNews.class, "content", userLang) %>
      <jalios:if predicate='<%= channel.isMultilingual() %>'><jalios:lang lang='<%= itLang %>'/></jalios:if>
      <% fieldDomId += "_" + itLang; %>
    </td>
    <% 
