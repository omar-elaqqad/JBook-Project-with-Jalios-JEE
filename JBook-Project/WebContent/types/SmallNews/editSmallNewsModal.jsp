...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/SmallNews/editSmallNewsModal.jsp">
<div class="row SmallNews">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/SmallNews/doEditSmallNewsModal.jsp" />
</div>
</jalios:modal>
<% 
