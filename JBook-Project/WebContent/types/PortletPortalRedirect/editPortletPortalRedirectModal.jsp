...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletPortalRedirect/editPortletPortalRedirectModal.jsp">
<div class="row PortletPortalRedirect">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletPortalRedirect/doEditPortletPortalRedirectModal.jsp" />
</div>
</jalios:modal>
<% 
