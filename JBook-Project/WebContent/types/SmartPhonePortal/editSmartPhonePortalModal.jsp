...
%><%--
  @Summary: SmartPhonePortal editor
  @Category: Generated
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/SmartPhonePortal/editSmartPhonePortalModal.jsp">
<div class="row SmartPhonePortal">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/SmartPhonePortal/doEditSmartPhonePortalModal.jsp" />
</div>
</jalios:modal>
<% 
