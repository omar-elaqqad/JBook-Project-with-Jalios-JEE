...
%><%--
  @Summary: PortletRecentHistory editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletRecentHistoryHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletRecentHistory/editPortletRecentHistoryModal.jsp">
<div class="row PortletRecentHistory">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletRecentHistory/doEditPortletRecentHistoryModal.jsp" />
</div>
</jalios:modal>
<% 
