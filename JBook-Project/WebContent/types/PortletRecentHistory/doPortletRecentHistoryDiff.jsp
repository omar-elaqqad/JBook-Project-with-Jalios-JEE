...
<%--
  @Summary: generated.PortletRecentHistory diff page
  @Category: Generated
...
<% 
{ 
generated.PortletRecentHistory newObj = (generated.PortletRecentHistory)request.getAttribute("newPub"); 
generated.PortletRecentHistory oldObj = (generated.PortletRecentHistory)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletRecentHistory.class);
...
<% } %>
  ...
  <%-- ** historySize ***************** --%>
  <jalios:if predicate='<%= newObj.getHistorySize() != oldObj.getHistorySize() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletRecentHistory.class, "historySize", userLang) %></td>
    <td><%= newObj.getHistorySize()  %></td>
    <td><%= oldObj.getHistorySize()  %></td>
  </tr>
  </jalios:if>
  <%-- ** pageSize ***************** --%>
  <jalios:if predicate='<%= newObj.getPageSize() != oldObj.getPageSize() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletRecentHistory.class, "pageSize", userLang) %></td>
    <td><%= newObj.getPageSize()  %></td>
    <td><%= oldObj.getPageSize()  %></td>
  </tr>
  </jalios:if>
  <%-- ** filterOnCurrentWorkspace ***************** --%>
  <jalios:if predicate='<%= newObj.getFilterOnCurrentWorkspace() != oldObj.getFilterOnCurrentWorkspace() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletRecentHistory.class, "filterOnCurrentWorkspace", userLang) %></td>
    <td><%= newObj.getFilterOnCurrentWorkspaceLabel(userLang) %></td>
    <td><%= oldObj.getFilterOnCurrentWorkspaceLabel(userLang) %></td>
  </tr>
  </jalios:if>
<%
