...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletSignUp/editPortletSignUpModal.jsp">
<div class="row PortletSignUp">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletSignUp/doEditPortletSignUpModal.jsp" />
</div>
</jalios:modal>
<% 
