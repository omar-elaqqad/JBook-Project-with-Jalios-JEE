...
<%
  TypeFieldEntry tfe = channel.getTypeFieldEntry(PortletSearch.class, "displayPortal", true);
  PublicationSettings displayPortalSettings = (PublicationSettings)(tfe.getControlSettings());
  displayPortalSettings.superType(PortalInterface.class);
%>
<%-- DisplayPortal ------------------------------------------------------------ --%>
<jalios:field name="displayPortal" formHandler="<%= formHandler %>">
  <jalios:control settings="<%= displayPortalSettings %>"/>
</jalios:field>
