...
%><%--
  @Summary: PortletCarousel editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletCarouselHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletCarousel/editPortletCarouselModal.jsp">
<div class="row PortletCarousel">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletCarousel/doEditPortletCarouselModal.jsp" />
</div>
</jalios:modal>
<% 
