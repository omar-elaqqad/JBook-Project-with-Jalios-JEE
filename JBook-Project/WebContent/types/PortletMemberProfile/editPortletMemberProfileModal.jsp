...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletMemberProfile/editPortletMemberProfileModal.jsp">
<div class="row PortletMemberProfile">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletMemberProfile/doEditPortletMemberProfileModal.jsp" />
</div>
</jalios:modal>
<% 
