...
<%--
  @Summary: generated.PortletBookmarks diff page
  @Category: Generated
...
<% 
{ 
generated.PortletBookmarks newObj = (generated.PortletBookmarks)request.getAttribute("newPub"); 
generated.PortletBookmarks oldObj = (generated.PortletBookmarks)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletBookmarks.class);
...
<% } %>
  ...
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletBookmarks.class, "openLinksInNewWindow", userLang) %></td>
