...
%><%--
  @Summary: PortletBookmarks editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletBookmarksHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletBookmarks/editPortletBookmarksModal.jsp">
<div class="row PortletBookmarks">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletBookmarks/doEditPortletBookmarksModal.jsp" />
</div>
</jalios:modal>
<% 
