...
<%--
  @Summary: generated.BlogRequest diff page
  @Category: Generated
...
<% 
{ 
generated.BlogRequest newObj = (generated.BlogRequest)request.getAttribute("newPub"); 
generated.BlogRequest oldObj = (generated.BlogRequest)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.BlogRequest.class);
...
<% } %>
  ...
  <tr class="vTop">
    ...
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.BlogRequest.class, "description", userLang) %>
      <jalios:if predicate='<%= channel.isMultilingual() %>'><jalios:lang lang='<%= itLang %>'/></jalios:if>
      <% fieldDomId += "_" + itLang; %>
    </td>
    <% 
