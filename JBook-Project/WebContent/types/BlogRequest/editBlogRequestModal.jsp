...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/BlogRequest/editBlogRequestModal.jsp">
<div class="row BlogRequest">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/BlogRequest/doEditBlogRequestModal.jsp" />
</div>
</jalios:modal>
<% 
