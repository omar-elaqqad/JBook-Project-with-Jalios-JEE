...
<%--
  @Summary: BlogRequest report page
  @Category: Generated
...
<% 
SortedSet tmpResultSet = channel.getPublicationSet(BlogRequest.class, loggedMember, false);
...
%>
<p class='t1'><%= channel.getTypeLabel(BlogRequest.class, userLang) %></p>
<%-- --- Summary ---------------------------------------------------------------------- --%>
