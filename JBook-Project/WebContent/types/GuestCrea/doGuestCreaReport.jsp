...
<% 
SortedSet tmpResultSet = channel.getPublicationSet(GuestCrea.class, loggedMember, false);
...
%>
<p class='t1'><%= channel.getTypeLabel(GuestCrea.class, userLang) %></p>
<%-- --- Summary ---------------------------------------------------------------------- --%>
