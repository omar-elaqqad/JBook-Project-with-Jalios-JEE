...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/GuestCrea/editGuestCreaModal.jsp">
<div class="row GuestCrea">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/GuestCrea/doEditGuestCreaModal.jsp" />
</div>
</jalios:modal>
<% 
