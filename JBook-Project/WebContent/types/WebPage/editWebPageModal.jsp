...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditWebPageHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/WebPage/editWebPageModal.jsp">
<div class="row WebPage">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/WebPage/doEditWebPageModal.jsp" />
</div>
</jalios:modal>
<% 
