...
%><%--
  @Summary: PortletPublication editor
  @Category: Generated
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletPublication/editPortletPublicationModal.jsp">
<div class="row PortletPublication">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletPublication/doEditPortletPublicationModal.jsp" />
</div>
</jalios:modal>
<% 
