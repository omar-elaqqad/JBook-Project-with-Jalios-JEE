...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletPoll/editPortletPollModal.jsp">
<div class="row PortletPoll">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletPoll/doEditPortletPollModal.jsp" />
</div>
</jalios:modal>
<% 
