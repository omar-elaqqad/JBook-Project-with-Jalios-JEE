...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/DBWebPage/editDBWebPageModal.jsp">
<div class="row DBWebPage">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/DBWebPage/doEditDBWebPageModal.jsp" />
</div>
</jalios:modal>
<% 
