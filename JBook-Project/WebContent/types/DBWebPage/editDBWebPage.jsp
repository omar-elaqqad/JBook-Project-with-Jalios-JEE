...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditDBWebPageHandler'><%
...
<div class="container-fluid">
  <div class="row DBWebPage">
    <jalios:include jsp="types/DBWebPage/doEditDBWebPage.jsp" />
  </div>
</div>
<% 
