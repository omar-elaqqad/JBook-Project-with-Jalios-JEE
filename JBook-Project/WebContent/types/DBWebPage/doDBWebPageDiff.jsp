...
<%--
  @Summary: generated.DBWebPage diff page
  @Category: Generated
...
<% 
{ 
generated.DBWebPage newObj = (generated.DBWebPage)request.getAttribute("newPub"); 
generated.DBWebPage oldObj = (generated.DBWebPage)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.DBWebPage.class);
...
%>
<jsp:include page="/types/WebPage/doWebPageDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
