...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortalJspCollection/editPortalJspCollectionModal.jsp">
<div class="row PortalJspCollection">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortalJspCollection/doEditPortalJspCollectionModal.jsp" />
</div>
</jalios:modal>
<% 
