...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/BlogPost/editBlogPostModal.jsp">
<div class="row BlogPost">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/BlogPost/doEditBlogPostModal.jsp" />
</div>
</jalios:modal>
<% 
