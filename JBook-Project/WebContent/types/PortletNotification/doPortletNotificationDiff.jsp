...
<%--
  @Summary: generated.PortletNotification diff page
  @Category: Generated
...
<% 
{ 
generated.PortletNotification newObj = (generated.PortletNotification)request.getAttribute("newPub"); 
generated.PortletNotification oldObj = (generated.PortletNotification)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletNotification.class);
...
<% } %>
  ...
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletNotification.class, "maxResults", userLang) %></td>
