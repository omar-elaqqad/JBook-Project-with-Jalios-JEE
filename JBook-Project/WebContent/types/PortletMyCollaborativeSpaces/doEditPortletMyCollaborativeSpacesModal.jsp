...
<%--
  @Summary: PortletMyCollaborativeSpaces modal content editor
  @Category: Generated
...
</div><div id="PortletMyCollaborativeSpaces_super_tab" class="clearfix separator">
