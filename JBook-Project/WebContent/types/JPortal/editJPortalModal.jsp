...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditJPortalHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/JPortal/editJPortalModal.jsp">
<div class="row JPortal">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/JPortal/doEditJPortalModal.jsp" />
</div>
</jalios:modal>
<% 
