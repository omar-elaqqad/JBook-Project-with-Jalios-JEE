...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletBlogHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletBlog/editPortletBlogModal.jsp">
<div class="row PortletBlog">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletBlog/doEditPortletBlogModal.jsp" />
</div>
</jalios:modal>
<% 
