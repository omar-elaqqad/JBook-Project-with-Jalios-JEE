...
<%--
  @Summary: generated.PortletBlog diff page
  @Category: Generated
...
<% 
{ 
generated.PortletBlog newObj = (generated.PortletBlog)request.getAttribute("newPub"); 
generated.PortletBlog oldObj = (generated.PortletBlog)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletBlog.class);
...
<% } %>
  ...
  <%-- ** displayedList ***************** --%>
  <jalios:if predicate='<%= !Util.isSameContent(newObj.getDisplayedList(), oldObj.getDisplayedList()) %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.PortletBlog.class, "displayedList", userLang) %>
    </td>
    <td><%= Util.getString(newObj.getDisplayedList(), "") %></td>
    <td><%= Util.getString(oldObj.getDisplayedList(), "") %></td>
  </tr>
  </jalios:if>
<%
