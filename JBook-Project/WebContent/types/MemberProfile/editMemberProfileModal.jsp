...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditMemberProfileHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/MemberProfile/editMemberProfileModal.jsp">
<div class="row MemberProfile">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/MemberProfile/doEditMemberProfileModal.jsp" />
</div>
</jalios:modal>
<% 
