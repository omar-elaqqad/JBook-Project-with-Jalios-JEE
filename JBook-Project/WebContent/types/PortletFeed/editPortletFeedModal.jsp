...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletFeedHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletFeed/editPortletFeedModal.jsp">
<div class="row PortletFeed">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletFeed/doEditPortletFeedModal.jsp" />
</div>
</jalios:modal>
<% 
