...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletMenuHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletMenu/editPortletMenuModal.jsp">
<div class="row PortletMenu">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletMenu/doEditPortletMenuModal.jsp" />
</div>
</jalios:modal>
<% 
