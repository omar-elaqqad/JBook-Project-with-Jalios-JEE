...
%><%--
  @Summary: AbstractPortal display page
  @Category: Generated
...
%><% AbstractPortal obj = (AbstractPortal)portlet; %><%
%><%@ include file='/front/doFullDisplay.jspf' %>
<div class="fullDisplay AbstractPortal <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>" itemscope="itemscope">
<%@ include file='/front/publication/doPublicationHeader.jspf' %>
<table class="fields">
  <tr class="field pageTitle textfieldEditor  <%= Util.isEmpty(obj.getPageTitle(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "pageTitle", userLang) %><jalios:edit pub='<%= obj %>' fields='pageTitle'/></td>
  ...
  <tr class="field child linkEditor  <%= Util.isEmpty(obj.getChild()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "child", userLang) %><jalios:edit pub='<%= obj %>' fields='child'/></td>
    <td class='field-data' >
  ...
  <tr class="field cssFile enumerateEditor  <%= Util.isEmpty(obj.getCssFile()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "cssFile", userLang) %><jalios:edit pub='<%= obj %>' fields='cssFile'/></td>
  ...
  <tr class="field description textareaEditor abstract <%= Util.isEmpty(obj.getDescription(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "description", userLang) %><jalios:edit pub='<%= obj %>' fields='description'/></td>
  ...
  <tr class="field portletImage imageEditor  <%= Util.isEmpty(obj.getPortletImage(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "portletImage", userLang) %><jalios:edit pub='<%= obj %>' fields='portletImage'/></td>
  ...
  <tr class="field cacheType enumerateEditor  <%= Util.isEmpty(obj.getCacheType()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "cacheType", userLang) %><jalios:edit pub='<%= obj %>' fields='cacheType'/></td>
  ...
  <tr class="field cacheSensibility enumerateEditor  <%= Util.isEmpty(obj.getCacheSensibility()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "cacheSensibility", userLang) %><jalios:edit pub='<%= obj %>' fields='cacheSensibility'/></td>
  ...
  <tr class="field invalidClass enumerateEditor  <%= Util.isEmpty(obj.getInvalidClass()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "invalidClass", userLang) %><jalios:edit pub='<%= obj %>' fields='invalidClass'/></td>
  ...
  <tr class="field invalidTime durationEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "invalidTime", userLang) %><jalios:edit pub='<%= obj %>' fields='invalidTime'/></td>
    <td class='field-data' >
  ...
  <tr class="field behaviorCopy enumerateEditor  <%= Util.isEmpty(obj.getBehaviorCopy()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "behaviorCopy", userLang) %><jalios:edit pub='<%= obj %>' fields='behaviorCopy'/></td>
  ...
  <tr class="field cssId textfieldEditor  <%= Util.isEmpty(obj.getCssId()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "cssId", userLang) %><jalios:edit pub='<%= obj %>' fields='cssId'/></td>
  ...
  <tr class="field cssClasses textfieldEditor  <%= Util.isEmpty(obj.getCssClasses()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "cssClasses", userLang) %><jalios:edit pub='<%= obj %>' fields='cssClasses'/></td>
  ...
  <tr class="field exactCategory booleanEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(AbstractPortal.class, "exactCategory", userLang) %><jalios:edit pub='<%= obj %>' fields='exactCategory'/></td>
    <td class='field-data' >
