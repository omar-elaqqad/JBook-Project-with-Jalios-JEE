...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletLoginHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletLogin/editPortletLoginModal.jsp">
<div class="row PortletLogin">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletLogin/doEditPortletLoginModal.jsp" />
</div>
</jalios:modal>
<% 
