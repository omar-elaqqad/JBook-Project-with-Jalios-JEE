...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/Article/editArticleModal.jsp">
<div class="row Article">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/Article/doEditArticleModal.jsp" />
</div>
</jalios:modal>
<% 
