...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletIFrameHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletIFrame/editPortletIFrameModal.jsp">
<div class="row PortletIFrame">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletIFrame/doEditPortletIFrameModal.jsp" />
</div>
</jalios:modal>
<% 
