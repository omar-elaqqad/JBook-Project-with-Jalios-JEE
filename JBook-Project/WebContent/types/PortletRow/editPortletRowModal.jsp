...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletRowHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletRow/editPortletRowModal.jsp">
<div class="row PortletRow">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletRow/doEditPortletRowModal.jsp" />
</div>
</jalios:modal>
<% 
