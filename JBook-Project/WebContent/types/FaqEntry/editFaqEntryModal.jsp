...
%><% formHandler.prepare(); %>
<jalios:modal title ='<%= Util.notEmpty(formHandler.getPublication()) ? "ui.faq.modal.edit-entry.title" : "ui.faq.modal.add-entry.title" %>' formHandler="<%= formHandler %>" url="types/FaqEntry/editFaqEntryModal.jsp">
