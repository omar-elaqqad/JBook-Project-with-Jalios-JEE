...
%><%--
  @Summary: PortletMemberActivity editor
  @Category: Generated
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletMemberActivity/editPortletMemberActivityModal.jsp">
<div class="row PortletMemberActivity">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletMemberActivity/doEditPortletMemberActivityModal.jsp" />
</div>
</jalios:modal>
<% 
