...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(GuestRequest.class).getLabelMap()); %>
...
<jsp:include page="doEditGuestRequest.jsp" />
<tr>
