...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditGuestRequestHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/GuestRequest/editGuestRequestModal.jsp">
<div class="row GuestRequest">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/GuestRequest/doEditGuestRequestModal.jsp" />
</div>
</jalios:modal>
<% 
