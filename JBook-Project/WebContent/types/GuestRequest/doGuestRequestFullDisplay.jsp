...
%><%--
  @Summary: GuestRequest display page
  @Category: Generated
...
<div class="fullDisplay GuestRequest <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>" itemscope="itemscope">
<%@ include file='/front/publication/doPublicationHeader.jspf' %>
<table class="fields">
  <tr class="field groups groupEditor  <%= Util.isEmpty(obj.getGroups()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(GuestRequest.class, "groups", userLang) %><jalios:edit pub='<%= obj %>' fields='groups'/></td>
    <td class='field-data' >
