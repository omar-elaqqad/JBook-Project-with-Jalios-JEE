...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletColumnHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletColumn/editPortletColumnModal.jsp">
<div class="row PortletColumn">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletColumn/doEditPortletColumnModal.jsp" />
</div>
</jalios:modal>
<% 
