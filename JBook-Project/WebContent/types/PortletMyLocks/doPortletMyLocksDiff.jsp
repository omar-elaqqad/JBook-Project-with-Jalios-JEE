...
<%--
  @Summary: generated.PortletMyLocks diff page
  @Category: Generated
...
<% 
{ 
generated.PortletMyLocks newObj = (generated.PortletMyLocks)request.getAttribute("newPub"); 
generated.PortletMyLocks oldObj = (generated.PortletMyLocks)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletMyLocks.class);
...
<% } %>
  ...
  <%-- ** refineWorkspace ***************** --%>
  <jalios:if predicate='<%= newObj.getRefineWorkspace() != oldObj.getRefineWorkspace() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletMyLocks.class, "refineWorkspace", userLang) %></td>
    <td><%= newObj.getRefineWorkspaceLabel(userLang) %></td>
    <td><%= oldObj.getRefineWorkspaceLabel(userLang) %></td>
  </tr>
  </jalios:if>
<%
