...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/DBComment/editDBCommentModal.jsp">
<div class="row DBComment">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/DBComment/doEditDBCommentModal.jsp" />
</div>
</jalios:modal>
<% 
