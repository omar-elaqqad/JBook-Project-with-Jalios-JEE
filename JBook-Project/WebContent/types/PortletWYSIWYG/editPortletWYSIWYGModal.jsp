...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletWYSIWYG/editPortletWYSIWYGModal.jsp">
<div class="row PortletWYSIWYG">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletWYSIWYG/doEditPortletWYSIWYGModal.jsp" />
</div>
</jalios:modal>
<% 
