...
<%--
  @Summary: generated.PortletMemberStatus diff page
  @Category: Generated
...
<% 
{ 
generated.PortletMemberStatus newObj = (generated.PortletMemberStatus)request.getAttribute("newPub"); 
generated.PortletMemberStatus oldObj = (generated.PortletMemberStatus)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletMemberStatus.class);
...
<% } %>
  ...
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.PortletMemberStatus.class, "workspaceMembers", userLang) %></td>
