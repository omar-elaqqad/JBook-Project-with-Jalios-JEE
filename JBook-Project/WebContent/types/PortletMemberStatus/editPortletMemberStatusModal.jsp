...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletMemberStatus/editPortletMemberStatusModal.jsp">
<div class="row PortletMemberStatus">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletMemberStatus/doEditPortletMemberStatusModal.jsp" />
</div>
</jalios:modal>
<% 
