...
%><%--
  @Summary: AbstractCollection editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditAbstractCollectionHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/AbstractCollection/editAbstractCollectionModal.jsp">
<div class="row AbstractCollection">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/AbstractCollection/doEditAbstractCollectionModal.jsp" />
</div>
</jalios:modal>
<% 
