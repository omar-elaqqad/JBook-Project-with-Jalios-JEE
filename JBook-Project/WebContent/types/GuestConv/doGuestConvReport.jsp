...
<% 
SortedSet tmpResultSet = channel.getPublicationSet(GuestConv.class, loggedMember, false);
...
%>
<p class='t1'><%= channel.getTypeLabel(GuestConv.class, userLang) %></p>
<%-- --- Summary ---------------------------------------------------------------------- --%>
