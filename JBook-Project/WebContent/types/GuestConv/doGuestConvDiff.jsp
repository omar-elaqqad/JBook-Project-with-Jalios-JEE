...
<%--
  @Summary: generated.GuestConv diff page
  @Category: Generated
...
<% 
{ 
generated.GuestConv newObj = (generated.GuestConv)request.getAttribute("newPub"); 
generated.GuestConv oldObj = (generated.GuestConv)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.GuestConv.class);
...
<% } %>
  ...
  <%-- ** contact ***************** --%>
  <jalios:if predicate='<%= newObj.getContact() != oldObj.getContact() %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.GuestConv.class, "contact", userLang) %></td>
    <td>
      <% Data newLink = newObj.getContact(); %>
      <% if (newLink != null) { %> 
    ...
    <td>
      <% Data oldLink = oldObj.getContact(); %>
      <% if (oldLink != null) { %> 
