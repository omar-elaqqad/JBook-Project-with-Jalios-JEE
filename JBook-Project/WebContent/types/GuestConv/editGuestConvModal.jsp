...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/GuestConv/editGuestConvModal.jsp">
<div class="row GuestConv">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/GuestConv/doEditGuestConvModal.jsp" />
</div>
</jalios:modal>
<% 
