...
%><%--
  @Summary: PortletBirthday editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletBirthdayHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletBirthday/editPortletBirthdayModal.jsp">
<div class="row PortletBirthday">
  ...
  <%@ include file="/jcore/doWorkspaceField.jspf" %>
	...
	<% } %>
	<jalios:include jsp="types/PortletBirthday/doEditPortletBirthdayModal.jsp" />
</div>
</jalios:modal>
<% 
