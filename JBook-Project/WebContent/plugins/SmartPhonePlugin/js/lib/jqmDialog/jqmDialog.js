/*
 * https://github.com/snehatulsi/jquery-mobile-dynamic-dialog/blob/master/jqmDialog.js
 * Version 9dbf443 -- 15 Sep 2014
 */
(function($) {
    ...
    var alerts = {
        ...
        alert: function(type,message, title, callback, value, cancelButton, validateButton) {
        ...
        _createFooter : function(){
            ...
            switch(this.type){
                ...
                case 3:  
                    ...
                    let okBtnText = _this.validateButton != null ? _this.validateButton : jaliosSettings["confirm-dialog-ok"];
                    ...
                    let cancelBtnText = _this.cancelButton != null ? _this.cancelButton : jaliosSettings["confirm-dialog-close"];
                ...
                default: 
                    ...
                    var closebtn = $('<a>', {
                            text: jaliosSettings["confirm-dialog-close"]
                        })
                        .attr('data-rel', 'back')
                        .attr('data-role', 'button');
    ...
    $.jConfirm = function(message, title, callback, cancelButton, validateButton) {
        alerts.alert('Confirm',message, title, callback, null, cancelButton, validateButton);
    };
