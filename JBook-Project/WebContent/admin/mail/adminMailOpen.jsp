...
Member member = getMemberParameter("member");
Group  group  = getGroupParameter("group");
%>
...
<%
  ...
  String   selectedFromEmail  = mailHandler.getAvailableFromEmail() == null ? loggedMember.getEmail() : mailHandler.getAvailableFromEmail();
  FileDocument[] attachements = mailHandler.getAvailableAttachements();
  String   sendAllButton      = glp("ui.adm.mail.btn.send-all");
%>
<form class="form-horizontal" action="admin/mail/adminMailOpen.jsp" method="post" name="editForm">
