...
<%
  ...
  boolean toMember       = availableToMember != null;
  boolean toMembers      = availableToMember == null && availableToGroup == null;
  boolean toGroup        = availableToGroup  != null;
  boolean toGroups       = availableToMember == null && availableToGroup == null;
  ...
  Member   selectedMember     = mailHandler.getAvailableToMember() == null ? availableToMember : mailHandler.getAvailableToMember();
  List     selectedMembers    = mailHandler.getAvailableToMembers();
  Group    selectedGroup      = mailHandler.getAvailableToGroup()  == null ? availableToGroup : mailHandler.getAvailableToGroup();
...
%>
<form class="form-horizontal" action="admin/mail/popupMail.jsp" method="post" name="editForm">
