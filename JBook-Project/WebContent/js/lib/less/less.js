...
(function(window, undefined) {
    ...
    less.Parser = function Parser(env) {
        ...
        function getDebugInfo(index, inputStream, e) {
            return {
                lineNumber: getLocation(index, inputStream)
                    .line + 1,
            ...
            parsers: {
                ...
                entities: {
                    ...
                    url: function() {
                        ...
                        return new(tree.URL)((value.value != null || value instanceof tree.Variable) ? value : new(tree.Anonymous)(value), imports.paths);
                    },
        ...
        tree.functions = {
            ...
            round: function(n, f) {
                ...
                if (n instanceof tree.Dimension) {
                    return new(tree.Dimension)(number(n)
                        .toFixed(fraction), n.unit);
    ...
    function loadStyleSheet(sheet, callback, reload, remaining) {
        ...
        xhr(sheet.href, sheet.type, function(data, lastModified) {
            if (!reload && styles && lastModified && (new(Date)(lastModified)
                .valueOf() === new(Date)(styles.timestamp)
                .valueOf())) {
                // Use local copy
