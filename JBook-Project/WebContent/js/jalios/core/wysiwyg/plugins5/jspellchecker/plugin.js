...
(function () {
    ...
    var getLanguage = function (editor) {
      var defaultLanguage = jQuery(editor.getElement()).attr("xml:lang") || editor.getParam('language', 'en');
    ...
    var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
      editor.focus(false); // prevent JCMS-7157 + JCMS-7486
      var userSpellcheckCallback = getSpellcheckerCallback(editor);
      var spellCheckCallback = userSpellcheckCallback ? userSpellcheckCallback : defaultSpellcheckCallback(editor, pluginUrl, currentLanguageState);
      spellCheckCallback.call(editor.plugins.jspellchecker, name, data, successCallback, errorCallback);
    };
    ...
    var register$1 = function (editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState) {
      ...
      if (languageMenuItems.length > 1) {
        editor.ui.registry.addSplitButton('jspellchecker', splitButtonArgs);
      } else {
        editor.ui.registry.addToggleButton('jspellchecker', buttonArgs);
      }
      editor.ui.registry.addToggleMenuItem('jspellchecker', {
        text: 'Spellcheck',
        icon: 'spell-check',
    ...
    function Plugin () {
      global.add('jspellchecker', function (editor, pluginUrl) {
